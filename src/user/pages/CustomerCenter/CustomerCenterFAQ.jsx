  ...
  return (
    <div className='CustomerCenterfaq'>
      <div className='CustomerCenterfaq-body'>
        ...
        <button
          className={`faq-submenu-content-left ${selectedMenu === '회원리뷰' ? 'active' : ''}`}
        ...
        <div className='faq-main-body'>
          ...
          <div className='faq-main-menu'>
            ...
            <div className='faq-main-menu-display' onClick={handleToggle_1}>
              <div className='faq-main-menu-text'>
            ...
            {
              isExpanded_1 && (
              <div className='faq-main-menu-expanded-content'>
            ...
            <div className='faq-main-menu-display' onClick={handleToggle_2}>
              <div className='faq-main-menu-text'>
                Q. 반품/환불신청은 어떻게 하나요?
              </div>              
              <div className='faq-main-menu-button-faq'>
            ...
            <div className='faq-main-menu-display' onClick={handleToggle_3}>
              <div className='faq-main-menu-text'>
            ...
            <div className='faq-main-menu-display' onClick={handleToggle_4}>
              <div className='faq-main-menu-text'>
            ...
            <div className="faq-main-menu-inquiry">
              <button className="faq-main-menu-inquiry-button">
                  문의 작성
              </button>
            </div>
