...
import {
    Box, Paper, TextField, Button, Chip, Table, TableBody, TableCell, TableContainer,
    TableHead, TableRow, InputAdornment, FormControl, InputLabel, Select, MenuItem,
} from "@mui/material";
    ...
    useEffect(() => {
        const fetchData = async () => {
            ...
            try {
                ...
                setPrice({
                    cost: response.data.data.productPrice,
                    discount: response.data.data.productDiscountRate,
                    sale: response.data.data.productSalePrice
                });
